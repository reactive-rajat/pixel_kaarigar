...
const About = () => {
  ...
  return (
    <div className="about-page">
      ...
      {/* Timeline */}
      <section className="timeline-section card-1">
        <div className="container-lg">
          <SectionHeading
            label="Journey"
            title={
      ...
      <section className="deliver-section ">
        <div className="container-lg">
          ...
          <div className="container-lg deliver-grid">
            <div className="deliver-card card-md card-1">
      ...
      {/* Toolkit */}
      <section className="toolkit-section card-2">
        <div className="container-lg">
          <SectionHeading
          label="Toolkit"
          title={
      ...
      <section className="dual-cards-section card-1">
        <div className="container-lg">
          <SectionHeading
          label="Approach"
          title={
        ...
        <div className="container-md dual-grid">
          <div className="dual-card card-md card-1 visualist">
          ...
          <div className="dual-card card-md card-1 architect">
